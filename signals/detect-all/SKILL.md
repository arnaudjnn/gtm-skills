...
Run a full buying signal scan on a company domain with a single MCP tool call. This is the fastest way to check for signals — it runs 3 detections and returns only the ones that triggered.
